...
# from attention.model.dual_transformer_decoder import DualTransformerDecoder
from transformer.model.dual_transformer_decoder import DualTransformerDecoder
...
from transformer_trainer_validator import TransformerTrainerValidator
...
decoder = DualTransformerDecoder(len_tgt_vocab, key_size, query_size, value_size,
                                 num_hiddens, norm_shape, ffn_num_input,
                                 ffn_num_hiddens, num_heads, num_layers, dropout)
...
if __name__ == '__main__':
    if train_from_start:
        ...
        save_dir = os.path.join(paths.transformer_record_path, str(seed))
        # make sure directory exists
        os.makedirs(save_dir, exist_ok=True)
        # now safe to save checkpoint
